           ...
           <div className="absolute top-20 left-0 px-2 md:left-10 z-10 ">
               {
                   type&&(<div className='flex items-end'>
                       <div className='mr-4 font-medium text-white text-xl md:text-3xl rounded-md px-1' style={{background:"linear-gradient(to left,transparent 0%,rgb(0,0,0,0.2) 50%)"}}>{type==="movie"?"Movies":"Series"}</div>
                       <select value={genre} onChange={(e)=>handleSellect(e)} name="genre" id="genre" className='bg-black focus:outline-none outline-white outline-2 text-white rounded-md px-1 py-1'>
                          <option >Genre</option>
